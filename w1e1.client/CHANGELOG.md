...
- Crie um projeto react com create-vite: `npm init --yes vite@latest w1e1.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Criar o arquivo de projeto (`w1e1.client.esproj`).
