...
SELECT * FROM (SELECT ISNULL(SUM(F.ValorOrigem), 0) AS ValorTotalOrigens, COUNT(*) AS TotalDeDocumentosNoLote FROM final F WHERE 1=1  AND StatusDestino = 1) Q  ORDER BY 1 ASC
